    ...
    <ul class="dropdown-menu">
        ...
        <li class="user-header bg-light-blue">
            ...
            <p>
                ...
                <small>Бүртгэгдсэн огноо: {{ Auth::user()->created_at->format('M, Y') }}</small>
            </p>
        </li>
        <!-- Menu Body -->
        ...
        <li class="user-footer">
            <div class="pull-left">
                <a href="{{ route('admin.settings') }}" class="btn btn-default btn-flat">Тохиргоо</a>
            </div>
            <div class="pull-right">
                <a href="{{ route('admin.logout') }}" class="btn btn-default btn-flat">Гарах</a>
            </div>
        </li>
    </ul>
</li>
